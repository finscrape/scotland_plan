...
from scott.utils0 import cookies_parseead
...
class EastDunbartonshireSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://planning.eastdunbarton.gov.uk/online-applications/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.East_Dunbartonshire_Councils
        count = 0
        while True:
            try:
        ...
        for i in ii[0:]:
            ...
            for p in pcode:
                    ...
                    tx = f'_csrf=2328240e-ba64-4c58-ad15-8d625414d2f7&searchCriteria.uprn=&searchCriteria.propertyNameNumber=&searchCriteria.streetName=&searchCriteria.locality=&searchCriteria.town=&searchCriteria.postCode={p}&searchType=Property'
                    yield scrapy.Request(url=i,meta={'f':i,'p':p,'h':h},dont_filter= True,callback=self.parse,cookies=cookies_parseead(),method='POST',body=tx)
