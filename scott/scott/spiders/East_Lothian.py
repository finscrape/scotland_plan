...
from scott.utils0 import cookies_parseeal
...
class EastLothianSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://pa.eastlothian.gov.uk/online-applications/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.East_Lothian_Councils
        ...
        for i in ii[0:]:
            ...
            for p in pcode:
                    ...
                    tx = f'_csrf=26d92de4-61fd-4cb8-b96f-6fffd0cc61ad&searchCriteria.uprn=&searchCriteria.propertyNameNumber=&searchCriteria.streetName=&searchCriteria.locality=&searchCriteria.town=&searchCriteria.postCode={p}&searchType=Property'
                    yield scrapy.Request(url=i,meta={'f':i,'p':p,'h':h},dont_filter= True,callback=self.parse,cookies=cookies_parseeal(),method='POST',body=tx)
