...
from scott.utils0 import cookies_parseb
...
class AngusSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for i in numb:
            ...
            pay = f'_csrf=91729362-3ae8-4617-acb8-da7b290206d0&searchType=Application&searchCriteria.caseStatus=&searchCriteria.simpleSearchString={i}&searchCriteria.simpleSearch=true'
            headers = {
            ...
            yield scrapy.Request(url=ii[0],method='POST',body =pay,headers=headers,cookies=cookies_parseb(),meta={'h':head},dont_filter=True)
