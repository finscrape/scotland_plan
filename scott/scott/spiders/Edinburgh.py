...
from scott.utils0 import cookies_parseedb
...
class EdinburghSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://citydev-portal.edinburgh.gov.uk/idoxpa-web/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.Edinburgh_Councils
        count = 0
        while True:
            try:
