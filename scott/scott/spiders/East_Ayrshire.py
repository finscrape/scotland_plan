...
from scott.utils0 import cookies_parseeas
...
class EastAyrshireSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://eplanning.east-ayrshire.gov.uk/online/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.East_Ayrshire_Councils
        count = 0
        while True:
            try:
        ...
        for i in ii[0:]:
            ...
            for p in pcode:
                    ...
                    tx = f'_csrf=bb14f047-2d3b-4c4e-b07b-53a0b54d8c37&searchCriteria.uprn=&searchCriteria.propertyNameNumber=&searchCriteria.streetName=&searchCriteria.locality=&searchCriteria.town=&searchCriteria.postCode={p}&searchType=Property'
