...
class EastAyrshireSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://eplanning.east-ayrshire.gov.uk/online/search.do?action=property&type=atoz']
...
if __name__ == '__main__':
    #connecting to mongo
    URI = 'mongodb+srv://Bola:1234@cluster0.n0hftdw.mongodb.net/?retryWrites=true&w=majority'
    client = MongoClient(URI, tlsCAFile=ca)
    #scot1

    db = client.get_database('scotland')
    planning = db.East_Ayrshire_Council
    count = 0
    while True:
        try:
            planning.create_index([('Check', pymongo.ASCENDING)], unique=True)
    ...
    print('EastAyrshireSpider not selected!')