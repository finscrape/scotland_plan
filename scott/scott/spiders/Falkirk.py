...
from scott.utils0 import cookies_parseflk
...
class FalkirkSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://edevelopment.falkirk.gov.uk/online/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.Falkirk_Councils
        count = 0
        while True:
            try:
