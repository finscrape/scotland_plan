...
class ClackmannanshireSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://publicaccess.clacks.gov.uk/publicaccess/search.do?action=property&type=atoz']
...
if __name__ == '__main__':
    ...
    planning = db.Clackmannanshire_Council
    count = 0
    while True:
        try:
    ...
    print('ClackmannanshireSpider not selected!')