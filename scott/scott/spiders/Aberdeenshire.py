...
from scott.utils0 import cookies_parseabs
...
class AberdeenshireSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://upa.aberdeenshire.gov.uk/online-applications/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.Aberdeenshire_Councils
