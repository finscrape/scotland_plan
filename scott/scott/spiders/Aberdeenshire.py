...
class AberdeenshireSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://upa.aberdeenshire.gov.uk/online-applications/search.do?action=property&type=atoz']
...
if __name__ == '__main__':
    ...
    planning = db.Aberdeenshire_Council
    ...
    print('AberdeenshireSpider not selected!')
