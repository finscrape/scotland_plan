...
from scott.utils0 import cookies_parsedun
...
class DundeeSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://idoxwam.dundeecity.gov.uk/idoxpa-web/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.Dundee_City_Councils
        count = 0
        while True:
            try:
        ...
        for i in ii[0:]:
            ...
            for p in pcode[100000:]:
                    ...
                    tx = f'_csrf=e1704a64-25e5-495e-afa9-36f5b5a67f4a&searchCriteria.uprn=&searchCriteria.propertyNameNumber=&searchCriteria.streetName=&searchCriteria.locality=&searchCriteria.town=&searchCriteria.postCode={p}&searchType=Property'
                    yield scrapy.Request(url=i,meta={'f':i,'p':p,'h':h},dont_filter= True,callback=self.parse,cookies=cookies_parsedun(),method='POST',body=tx)
