...
from scott.utils0 import cookies_parseear
...
class EastrenfrewshireSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://planning.fife.gov.uk/online/propertySearchResults.do?action=firstPage']
        ...
        self.planning = db.East_Renfrewshire_Councils
        count = 0
        while True:
            try:
        ...
        for i in ii[0:]:
            ...
            for p in pcode:
                    ...
                    tx = f'_csrf=22bc8948-d7b6-40fc-aa20-83799887b171&searchCriteria.uprn=&searchCriteria.propertyNameNumber=&searchCriteria.streetName=&searchCriteria.locality=&searchCriteria.town=&searchCriteria.postCode={p}&searchType=Property'
                    yield scrapy.Request(url=i,meta={'f':i,'p':p,'h':h},dont_filter= True,callback=self.parse,cookies=cookies_parseear(),method='POST',body=tx)
