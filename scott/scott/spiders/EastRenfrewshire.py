...
class EastrenfrewshireSpider(scrapy.Spider):
    ...
    #connecting to mongo
    URI = 'mongodb+srv://Bola:1234@cluster0.iazmrod.mongodb.net/?retryWrites=true&w=majority'
    client = MongoClient(URI, tlsCAFile=ca)

    db = client.get_database('scotland')
    global planning
    planning = db.East_Renfrewshire_Council
    count = 0
    while True:
        try:
    ...
    def start_requests(self):
        ...
        ii = ['https://planning.fife.gov.uk/online/search.do?action=property&type=atoz']
