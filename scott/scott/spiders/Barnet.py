...
class BarnetSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        ii = ['https://publicaccess.barnet.gov.uk/online-applications/search.do?action=property&type=atoz']
        ...
        self.planning = db.Barnet_City_Council

        count = 0
        while True:
            try:
                self.planning.create_index([('Check', pymongo.ASCENDING)], unique=True)
                print('Barnet Connected successfully')
                sts = True
